...
// ─── DATA ─────────────────────────────────────────────────────────────────────
const GROUPS = {
  A: ['Argentina', 'Ecuador', 'Canadá', 'Marruecos'],
  B: ['Francia', 'Bélgica', 'México', 'Arabia Saudita'],
  C: ['Brasil', 'Colombia', 'Alemania', 'Japón'],
  D: ['España', 'Portugal', 'Uruguay', 'Ghana'],
  E: ['Inglaterra', 'Países Bajos', 'Senegal', 'EE.UU.'],
  F: ['Italia', 'Croacia', 'Camerún', 'Australia'],
}

const MATCHES = [
  { id: 1,  group: 'A', home: 'Argentina',     away: 'Ecuador',        date: '11 Jun' },
  { id: 2,  group: 'A', home: 'Canadá',         away: 'Marruecos',      date: '11 Jun' },
  { id: 3,  group: 'A', home: 'Argentina',     away: 'Canadá',         date: '15 Jun' },
  { id: 4,  group: 'A', home: 'Ecuador',        away: 'Marruecos',      date: '15 Jun' },
  { id: 5,  group: 'A', home: 'Argentina',     away: 'Marruecos',      date: '19 Jun' },
  { id: 6,  group: 'A', home: 'Ecuador',        away: 'Canadá',         date: '19 Jun' },
  { id: 7,  group: 'B', home: 'Francia',        away: 'Bélgica',        date: '12 Jun' },
  { id: 8,  group: 'B', home: 'México',         away: 'Arabia Saudita', date: '12 Jun' },
  { id: 9,  group: 'B', home: 'Francia',        away: 'México',         date: '16 Jun' },
  { id: 10, group: 'B', home: 'Bélgica',        away: 'Arabia Saudita', date: '16 Jun' },
  { id: 11, group: 'B', home: 'Francia',        away: 'Arabia Saudita', date: '20 Jun' },
  { id: 12, group: 'B', home: 'Bélgica',        away: 'México',         date: '20 Jun' },
  { id: 13, group: 'C', home: 'Brasil',         away: 'Colombia',       date: '12 Jun' },
  { id: 14, group: 'C', home: 'Alemania',       away: 'Japón',          date: '12 Jun' },
  { id: 15, group: 'C', home: 'Brasil',         away: 'Alemania',       date: '16 Jun' },
  { id: 16, group: 'C', home: 'Colombia',       away: 'Japón',          date: '16 Jun' },
  { id: 17, group: 'C', home: 'Brasil',         away: 'Japón',          date: '20 Jun' },
  { id: 18, group: 'C', home: 'Colombia',       away: 'Alemania',       date: '20 Jun' },
  { id: 19, group: 'D', home: 'España',         away: 'Portugal',       date: '13 Jun' },
  { id: 20, group: 'D', home: 'Uruguay',        away: 'Ghana',          date: '13 Jun' },
  { id: 21, group: 'D', home: 'España',         away: 'Uruguay',        date: '17 Jun' },
  { id: 22, group: 'D', home: 'Portugal',       away: 'Ghana',          date: '17 Jun' },
  { id: 23, group: 'D', home: 'España',         away: 'Ghana',          date: '21 Jun' },
  { id: 24, group: 'D', home: 'Portugal',       away: 'Uruguay',        date: '21 Jun' },
  { id: 25, group: 'E', home: 'Inglaterra',     away: 'Países Bajos',   date: '13 Jun' },
  { id: 26, group: 'E', home: 'Senegal',        away: 'EE.UU.',         date: '13 Jun' },
  { id: 27, group: 'E', home: 'Inglaterra',     away: 'Senegal',        date: '17 Jun' },
  { id: 28, group: 'E', home: 'Países Bajos',   away: 'EE.UU.',         date: '17 Jun' },
  { id: 29, group: 'E', home: 'Inglaterra',     away: 'EE.UU.',         date: '21 Jun' },
  { id: 30, group: 'E', home: 'Países Bajos',   away: 'Senegal',        date: '21 Jun' },
  { id: 31, group: 'F', home: 'Italia',         away: 'Croacia',        date: '14 Jun' },
  { id: 32, group: 'F', home: 'Camerún',        away: 'Australia',      date: '14 Jun' },
  { id: 33, group: 'F', home: 'Italia',         away: 'Camerún',        date: '18 Jun' },
  { id: 34, group: 'F', home: 'Croacia',        away: 'Australia',      date: '18 Jun' },
  { id: 35, group: 'F', home: 'Italia',         away: 'Australia',      date: '22 Jun' },
  { id: 36, group: 'F', home: 'Croacia',        away: 'Camerún',        date: '22 Jun' },
]

const ALL_TEAMS = [
  'Argentina','Brasil','Francia','España','Portugal','Alemania',
  'Inglaterra','Italia','Países Bajos','Bélgica','Uruguay','Colombia',
  'México','Ecuador','Croacia','Dinamarca','Suiza','Senegal',
  'Japón','Corea del Sur','Marruecos','Ghana','Nigeria','Camerún',
  'Australia','EE.UU.','Canadá','Arabia Saudita','Turquía','Serbia','Polonia','Qatar',
]

const TOP_SCORERS = [
  'Lionel Messi','Kylian Mbappé','Erling Haaland','Vinicius Jr.',
  'Harry Kane','Lautaro Martínez','Pedri','Jude Bellingham',
  'Rodri','Neymar Jr.','Luis Díaz','Antoine Griezmann',
]
...
const FLAG_EMOJIS = {
  ...
  'México':'🇲🇽','Ecuador':'🇪🇨','Croacia':'🇭🇷','Dinamarca':'🇩🇰',
  'Suiza':'🇨🇭','Senegal':'🇸🇳','Japón':'🇯🇵','Corea del Sur':'🇰🇷',
  'Marruecos':'🇲🇦','Ghana':'🇬🇭','Nigeria':'🇳🇬','Camerún':'🇨🇲',
  'Australia':'🇦🇺','EE.UU.':'🇺🇸','Canadá':'🇨🇦','Arabia Saudita':'🇸🇦',
  'Turquía':'🇹🇷','Serbia':'🇷🇸','Polonia':'🇵🇱','Qatar':'🇶🇦',
}
